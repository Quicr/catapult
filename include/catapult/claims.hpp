...
struct GeoCoordinate {
  ...
  /**
   * @brief Construct a geographic coordinate (validation happens during token
   * validation)
   ...
   * Template parameters are scaled by 10000 to avoid floating point template
   * issues
   */
   ...
   */
  static std::optional<GeoCoordinate>
  createSafe(double lat, double lon,
...
struct CatClaims {
  ...
  std::optional<std::vector<std::string>>
      catgeoiso3166; ///< Geographic restrictions (ISO 3166)
