...
int main() {
    ...
    auto [server_private_key, server_public_key] = Es256Algorithm::generateSecureKeyPair();
    ...
    moqt.addScope(
        publish_actions,
        MoqtBinaryMatch::exact("user-12345-stream"),
        MoqtBinaryMatch::any()
    );
    ...
    std::cout << "  - SUBSCRIBE/FETCH from any namespace, tracks prefixed 'public-'\n";
